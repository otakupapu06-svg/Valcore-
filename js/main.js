...
function init() {
  ...
  // Casa del protagonista — lado oeste, entre la plaza y la capilla
  buildHouse(-11, 3, { broken: false });

  // Casa de Nii — lado este, a buena distancia de la del protagonista
  // (no vecinas pegadas, pero sí a un paseo corto una de la otra)
  buildHouse(10, 8, { broken: false });
