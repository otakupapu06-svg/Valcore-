// Estado global compartido por todos los módulos (terrain.js, paths.js, etc.
...
function init() {
  ...
  // Paleta melancólica: azul-gris frío en vez del tono neutro anterior,
  // y niebla más cercana/densa — el pueblo se ve bonito, pero incómodo.
  const moodColor = 0x242b30;
  scene.background = new THREE.Color(moodColor);
  scene.fog = new THREE.Fog(moodColor, 10, 45);
  ...
  // Edificios (plaza, capilla, casas) — pendientes de reconstruir siguiendo
  // el trazado orgánico nuevo. Se agregan en la próxima pasada.
