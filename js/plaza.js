...
function buildPlazaLamps() {
  // 4 faroles en las esquinas — ahora son bombillas "falsas" (solo material
  // emissivo, sin PointLight real), así que no cuesta nada tener las 4 de
  // vuelta en vez de recortarlas por rendimiento.
  const poleMat = new THREE.MeshStandardMaterial({ color: 0x2a2a2a, roughness: 0.6, metalness: 0.4 });
  const headMat = new THREE.MeshStandardMaterial({
    color: 0xfff2c0, emissive: 0xffdd88, emissiveIntensity: 1.3
  });
  const positions = [
